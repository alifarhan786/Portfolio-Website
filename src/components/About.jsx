...
const About = () => {
  return (
    <div id="About" className=' h-screen w-full  bg-gradient-to-b from-pink-900 to-black text-white'>
      <div className='max-w-screen-lg  p-4 mx-auto flex flex-col justify-center  w-full h-full'>
        <div className='pb-8'>
          ...
          <div>
            ...
            <p className='px-6  md:px-4 text-4xl'>I am a BTech Grad Student from Jaipur Engineering College and Research Center, Jaipur (Rajasthan) </p>
          </div>
          <div>
